...
public class JCCExpressionsParser implements JCCExpressionsParserConstants {
  ...
  final public Program Program() throws ParseException {NodeList<Statement> ss = new NodeList<Statement>();
        Statement s;
        Expression e;
    label_1:
    while (true) {
...
{if ("" != null) return new Assign(name, value);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return new IntegerLiteral(t.image);}
    ...
    case IDENTIFIER:{
      i = Identifier();
{if ("" != null) return new IdentifierExp(i);}
      break;
      }
    case LPAREN:{
